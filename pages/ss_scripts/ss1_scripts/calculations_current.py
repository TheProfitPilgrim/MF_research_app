...
MF_calc.to_csv(r"Data/Output/MF_calc_current.csv", index=False)

# NIFTY RETURNS CALCULATIONS

df_in_index = pd.read_csv(r"Data/Input/nifty_eom.csv")
...
nifty_returns_df.to_csv(r"Data/Output/Nifty_Returns_current.csv", index=False)